...
def generate_launch_description():
    ...
    # Launch demo.launch.py with our new world
    ...
    # Launch the vision grasping node
    vision_node = Node(
    ...
    # Launch the new PyQt5 GUI instead of rqt
    gui_node = Node(
        package="seven_dof_arm_gazebo",
        executable="gui_pick_place.py",
        name="gui_pick_place_node",
        output="screen",
    )
